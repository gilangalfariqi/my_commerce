...
<style>
    ...
    @keyframes dot-pulse {
        0%, 100% { box-shadow: 0 0 0 0 color-mix(in srgb, var(--c-primary) 40%, transparent); }
    ...
    <div class="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 flex-wrap">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-3">
                <span class="w-2 h-2 rounded-full theme-bg dot-pulse"></span>
                <span class="text-xs font-bold theme-text uppercase tracking-widest">
            ...
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight mb-3">
                Katalog <span class="bg-gradient-to-r from-[var(--c-primary)] to-[var(--c-secondary)] bg-clip-text text-transparent">Sparepart</span> Motor
            </h1>
        ...
        <div class="flex items-center gap-3 theme-bg-10 border theme-border-20 backdrop-blur-sm rounded-2xl px-4 py-3 flex-shrink-0">
            <span class="text-2xl">🏍️</span>
            <div class="min-w-0">
                <span class="block text-[10px] font-bold theme-text uppercase tracking-widest">Sparepart untuk:</span>
            ...
            <a href="{{ route('products.index') }}" class="ml-2 flex items-center gap-1 text-xs text-slate-400 hover:theme-text border border-slate-700/60 theme-border-hover-30 rounded-xl px-2.5 py-1.5 transition-all whitespace-nowrap">
